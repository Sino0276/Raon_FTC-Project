...
public class AutoDrivingRED_Long extends LinearOpMode {
...
//                                .splineTo(new Vector2d(61, -10), Math.toRadians(160))
//                                .turnTo(160)
                                .turn(-20)
                                .build(),
...
//                        drive.getRoadRunnerDrive().actionBuilder(new Pose2d(61, -10, Math.toRadians(160)))
